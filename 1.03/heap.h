...
void heap_init(heap_t *h,
               int32_t (*compare)(const void *key, const void *with),
               void (*datum_delete)(void *)); //should just pass in null
void heap_delete(heap_t *h); //will have empty heap but should run anyway
heap_node_t *heap_insert(heap_t *h, void *v); //add item to heap
